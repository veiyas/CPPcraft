...
PerlinNoise::PerlinNoise(unsigned seed)
{
    ...
    permutation.resize(257);

    std::iota(permutation.begin(), permutation.end(), 0);

    std::shuffle(permutation.begin(), permutation.end(), engine);

    permutation.insert(permutation.begin(), permutation.end(), permutation.end());
}
...
double PerlinNoise::grad(int hs, double x, double y, double z)
{
    int h = hs & 15;
...
double PerlinNoise::noise(double x, double z, double y)
{
